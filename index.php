            ...
            <div class="container">
                ...
                <ul class="navbar-nav navbar-nav-hover mx-auto">
                    <li class="nav-item mx-2">
                        <a href="https://amkadamiyya.com.ng" class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center" role="button">Home</a>
                    </li>
        ...
        <section class="py-7">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 my-auto position-relative d-none d-lg-block">
                    <img class="w-100 position-relative" src="https://demos.creative-tim.com/soft-ui-design-system-pro/assets/img/illustrations/error-404.png" alt="404-error">
                </div>
            </div>
            </div>
        </section>
